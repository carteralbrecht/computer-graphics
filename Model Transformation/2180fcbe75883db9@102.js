// https://observablehq.com/@spattana/scaled-teapot@102
import define1 from "./4999f76212508574@211.js";
import define2 from "./ebae0c172bd689cc@92.js";
...
`
  ...
  main.variable(observer("scaledTeapot")).define("scaledTeapot", ["scaledSC","obj2sc","FileAttachment"], async function(scaledSC,obj2sc,FileAttachment){return(
scaledSC(obj2sc(await FileAttachment("teapot.obj").text()))
)});
  main.variable(observer("scaledCow")).define("scaledCow", ["scaledSC","obj2sc","FileAttachment"], async function(scaledSC,obj2sc,FileAttachment){return(
scaledSC(obj2sc(await FileAttachment("cow.obj").text()))
)});
  main.variable(observer("scaledTeddy")).define("scaledTeddy", ["scaledSC","obj2sc","FileAttachment"], async function(scaledSC,obj2sc,FileAttachment){return(
scaledSC(obj2sc(await FileAttachment("teddy.obj").text()))
)});
...
FileAttachment("teapot.obj").text()
  ...
  main.variable(observer("scaledBoy")).define("scaledBoy", ["scaledSC","obj2sc","boyObj"], function(scaledSC,obj2sc,boyObj){return(
scaledSC(obj2sc(boyObj))
)});
...
require('https://bundle.run/angle-normals@1.0.0')
  ...
  main.import("scaledSC", child1);
  const child2 = runtime.module(define2);
  main.import("obj2sc", child2);
